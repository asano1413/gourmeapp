...
export default function Terms() {
  return (
    <AppLayout>
      <div className="container mt-12 mx-auto py-8 px-4 bg-gray-50 text-gray-700">
        ...
        <h2 className="text-xl font-bold mb-2">第3条（ユーザーIDおよびパスワードの管理）</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          （4）管理者のサービスの運営を妨げる行為
          <br />
          （5）他の利用者に関する個人情報を収集または蓄積する行為
          <br />
        </p>
        <h2 className="text-xl font-bold mb-2">第5条（本サービスの提供の停止等）</h2>
        <p className="mb-4">
          1. 管理者は，以下のいずれかの事由があると判断した場合，利用者に事前の通知なく本サービスの提供を停止または中断することができるものとします。
          <br />
          （1）定期保守または緊急保守のために本サービスの提供が必要となった場合
          <br />
          （2）火災，停電，天災などの不可抗力により本サービスの提供が困難となった場合
          <br />
          （3）その他，管理者が本サービスの提供が困難と判断した場合
        </p>
        <h2 className="text-xl font-bold mb-2">第6条（利用制限および登録抹消）</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-bold mb-2">第7条（免責事項）</h2>
        <p className="mb-4">
          1. 管理者の債務不履行責任は，過失または故意によらない場合には免責されるものとします。
        </p>
        <h2 className="text-xl font-bold mb-2">第8条（サービス内容の変更等）</h2>
        <p className="mb-4">
          管理者は，利用者に通知することなく，本サービスの内容を変更し，または本サービスの提供を中止することができるものとします。
        </p>
        <h2 className="text-xl font-bold mb-2">第9条（利用規約の変更）</h2>
        <p className="mb-4">
          管理者は，必要と判断した場合には，本規約を変更することができるものとします。
        </p>
        <h2 className="text-xl font-bold mb-2">第10条（通知または連絡）</h2>
        <p className="mb-4">
          1. 利用者と管理者との間の通知または連絡は，管理者の定める方法によって行うものとします。
        </p>
        <h2 className="text-xl font-bold mb-2">第11条（権利義務の譲渡の禁止）</h2>
        <p className="mb-4">
          利用者は，管理者の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
        </p>
        <h2 className="text-xl font-bold mb-2">第12条（準拠法）</h2>
        <p className="mb-4">
          1. 本規約の解釈にあたっては，日本法を準拠法とします。
        </p>
        <h2 className="text-xl font-bold mb-2">第13条（管轄）</h2>
        <p className="mb-4">
